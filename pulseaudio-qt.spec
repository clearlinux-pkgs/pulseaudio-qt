...
Source0  : https://download.kde.org/stable/pulseaudio-qt/pulseaudio-qt-1.4.0.tar.xz
Source1  : https://download.kde.org/stable/pulseaudio-qt/pulseaudio-qt-1.4.0.tar.xz.sig
...
%prep
%setup -q -n pulseaudio-qt-1.4.0
cd %{_builddir}/pulseaudio-qt-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710514297
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF6PulseAudioQt.so.1.4.0
/usr/lib64/libKF6PulseAudioQt.so.4
